package com.lopez.app.escuela.controllers;
...
import com.lopez.app.escuela.dtos.AlumnoCreateDTO;
import com.lopez.app.escuela.dtos.AlumnoListDTO;
import com.lopez.app.escuela.services.IService;
...
public class AlumnosController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<AlumnoListDTO> actualizarAlumno(@Valid @RequestBody AlumnoCreateDTO alumnoDTO,
	...
	public ResponseEntity<Map<String,String>> eliminarAlumno(@PathVariable(name = "id") long id){
		...
		mapa.put("message","Alumno eliminado correctamente");
