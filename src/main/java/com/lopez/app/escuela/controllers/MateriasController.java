...
public class MateriasController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<MateriaListDTO> actualizarMateria(@Valid @RequestBody MateriaCreateDTO materiaDTO,
	...
	public ResponseEntity<Map<String,String>> eliminarMateria(@PathVariable(name="id")long id){
		...
		mapa2.put("message","Materia eliminada correctamente");
		materiasService.delete(id);
		return new ResponseEntity<>(mapa2,HttpStatus.OK);
	}
}