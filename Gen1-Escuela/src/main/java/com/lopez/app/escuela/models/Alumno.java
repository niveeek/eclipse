...
public class Alumno {
	...
	@OneToMany(mappedBy = "alumno", cascade = CascadeType.ALL) //establece relacion bidireccional
	//nombre del atributo de la relacion original mappedBy
	private Set<Calificacion> calificaciones; //muchas calificaciones se emplea con SET
